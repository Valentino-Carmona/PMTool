...
6.1 Para finalizar un proyecto, todas sus actividades deberán estar completadas.  
...
| 1.3        | Todas las actividades completadas para finalizar proyecto                       | Negocio                 | 2.6, 3.1.4                          | Must          | PMTool-003               | US-06-cambiar-estado-proyecto.feature |
| 1.4        | Control de tiempos planificados y reales                                        | Negocio                 | 2.2, 3.1.2, 3.2.4                   | Should        | PMTool-002               | US-04-planificar-actividades.feature, US-06-cambiar-estado-proyecto.feature |
...
| 2.2        | Planificar fechas de inicio y fin para proyectos                                | Usuario                 | 1.4, 3.1.2                          | Must          | PMTool-002               | US-06-cambiar-estado-proyecto.feature |
| 2.3        | Crear actividades organizadas en EDT                                            | Usuario                 | 1.2, 3.2.1, 3.2.2, 3.2.3, 3.2.8     | Must          | PMTool-002               | US-04-planificar-actividades.feature, US-08-agregar-subactividad.feature |
| 2.4        | Visualizar jerarquía completa de actividades                                    | Usuario                 | 1.2, 3.2.2.2, 3.2.9, 5.2            | Should        | PMTool-002               | US-09-consultar-jerarquia-edt.feature |
| 2.5        | Activar o desactivar actividades para reflejar estado                           | Usuario                 | 3.2.5, 3.2.5.1, 3.2.5.2             | Must          | PMTool-003               | US-07-activar-actividad.feature, US-05-finalizar-actividad.feature |
| 2.6        | Finalizar proyecto solo si todas las actividades completadas                    | Usuario                 | 1.3, 3.1.4                          | Must          | PMTool-003               | US-06-cambiar-estado-proyecto.feature |
...
| 3.1.2      | Establecer fechas planificadas y pasar a EN_CURSO                               | Funcional               | 1.4, 2.2                            | Must          | PMTool-002               | US-06-cambiar-estado-proyecto.feature |
...
| 3.1.4      | Finalizar proyecto solo si todas las actividades completadas                    | Funcional               | 1.3, 2.6                            | Must          | PMTool-003               | US-06-cambiar-estado-proyecto.feature |
...
| 3.2.1      | Crear actividades principales dentro de un proyecto                            | Funcional               | 2.3, 3.2.1.1, 3.2.8                 | Must          | PMTool-002               | US-04-planificar-actividades.feature |
...
| 3.2.2.1    | Asignación automática de números EDT según jerarquía                            | Funcional               | 3.2.2                               | Should        | PMTool-002               | US-08-agregar-subactividad.feature |
| 3.2.2.2    | Mostrar jerarquía completa con numeración EDT                                   | Funcional               | 2.4, 3.2.2, 3.2.9, 5.2              | Should        | PMTool-002               | US-09-consultar-jerarquia-edt.feature |
| 3.2.3      | Crear subactividades dentro de actividades existentes                           | Funcional               | 2.3, 3.2.2, 3.2.8                   | Must          | PMTool-002               | US-08-agregar-subactividad.feature |
| 3.2.4      | Establecer fechas planificadas para actividades                                 | Funcional               | 1.4, 2.3                            | Must          | PMTool-002               | US-04-planificar-actividades.feature |
| 3.2.5      | Cambiar estado de actividades (PLANIFICADA, EN_EJECUCION, COMPLETADA)           | Funcional               | 2.5, 3.1.3, 3.2.5.1, 3.2.5.2        | Must          | PMTool-003               | US-07-activar-actividad.feature, US-05-finalizar-actividad.feature |
| 3.2.5.1    | Activar actividad (cambiar a EN_EJECUCION)                                      | Funcional               | 2.5, 3.2.5, 3.2.5.1.1               | Must          | PMTool-003               | US-07-activar-actividad.feature |
