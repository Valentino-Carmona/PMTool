...
- **Dependencia**: Modela las relaciones de precedencia entre actividades, requisito 3.2.7, incluyendo los tipos de dependencias (FS, SS, FF, SF) y retrasos/adelantos lag y lead. Las relaciones "Dependencia "0..*" -- "1" Actividad : origen/destino" aseguran que cada dependencia vincule exactamente dos actividades, mientras que una actividad puede tener cero o más dependencias.
