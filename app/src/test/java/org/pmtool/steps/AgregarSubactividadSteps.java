...
public class AgregarSubactividadSteps {
  ...
  @Then(
      "se muestra un mensaje de error indicando que no se pueden agregar subactividades a una actividad completada")
  public void
      seMuestraUnMensajeDeErrorIndicandoQueNoSePuedenAgregarSubactividadesAUnaActividadCompletada() {
    assertNotNull(excepcion);
    assertEquals(
        "No se pueden agregar subactividades a una actividad completada", excepcion.getMessage());
  }
}
