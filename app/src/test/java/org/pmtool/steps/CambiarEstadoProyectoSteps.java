...
public class CambiarEstadoProyectoSteps {
  ...
  @Then(
      "se informa un mensaje indicando que el proyecto debe estar en curso para poder finalizarlo")
  ...
  @Then(
      "se muestra un mensaje de error indicando que todas las actividades deben estar completadas")
  public void seMuestraUnMensajeDeErrorIndicandoQueTodasLasActividadesDebenEstarCompletadas() {
    assertNotNull(exception);
    assertEquals(
        "Para finalizar un proyecto todas sus actividades deben estar completadas",
